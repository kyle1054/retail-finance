...
![Undercharge timeline](docs/img/recovery.png)

<sub>The financial timeline for a single undercharge: the original amount, what
was actually deducted, what the customer paid, and the balance — over a
versioned payroll schedule, with every settlement and adjustment recorded
underneath.</sub>
